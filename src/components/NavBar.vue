            ...
            <b-collapse id="nav-collapse" is-nav>
                <b-navbar-nav v-show="showFunctions">
                    ...
                    <b-nav-item-dropdown
                            ...
                            right
                    >
                        <b-dropdown-item to="/lista-categorias">Categorias</b-dropdown-item>
                        <b-dropdown-item to="/novo-produto">Nova Categoria</b-dropdown-item>
                        <b-dropdown-item to="/novos-produtos">Novo Produto</b-dropdown-item>
